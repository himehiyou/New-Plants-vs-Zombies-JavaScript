var CZombies = function(b, a) {
    ...
    return (a = function() {}).prototype = {
      ...
      getHTML: function(d, g, i, h, f, k, j, c) {
        ...
        return e[0] + d + e[1] + f + e[2] + g + e[3] + i + e[4] + h + e[5] + k + e[6] + j + e[7] + c + e[
  ...
  oBackupDancer = InheritO(OrnNoneZombies, {
    ...
    Produce: 'When the dancer zombies sway, four of these zombies appear in groups. </p><p>Toughness: <font color="#FF0000">Low</font><br>The backup dancer Zombie studied dance skills for six years at the "Zui Teeth" Performing Arts Academy in Zombie New York City. . ',
    ...
    ChangeChkActsTo1: function(c, b, a) {
      ...
      c . PZ & & o Sym . addTask ( 220 , function ( e , d ) {
  ...
  oDancingZombie = InheritO(OrnNoneZombies, {
    ...
    Produce: 'Any resemblance between the dancer zombies and humans (living or dead) is purely coincidental. </p><p>Toughness: <font color="#FF0000">Medium</font><br>Features: <font color="#FF0000">Summons dancing zombies</font></p>Dancers Zombie's latest record, "Grab the Brain and Gibble, Gibble," is experiencing a meteoric rise in popularity within the zombie community. ',
    ...
    AttackZombie: function(a) {
      ...
      oSym.addTask(10, function(d, c) {
        ...
        f && f.beAttacked && !f.FreeFreezeTime && !f.FreeSetbodyTime && ((e = $Z[c]) ? (e.getHit0(e, 10, 0), oSym.addTask(10, arguments.call, [; d, c])) : (f.isAttacking = 0, f.EleBody.src = f.PicArr[f.NormalGif], f.TurnLeft(f)));
  ...
  oZombie = InheritO(OrnNoneZombies, {
    ...
    Produce: 'Toughness: <font color="#FF0000">Low</font></p>This kind of zombie loves brains, is greedy and insatiable. Brain, brain, brain, pursuing it day and night. Old and smelly brain? Rotten brain? It doesn't matter. Zombies need them. '
  ...
  oMustacheZombie = InheritO(oZombie, {
    ...
    CName: "bearded zombie",

    HP: 540,

    Produce: 'Mysterious zombies haunt the Evergreen Tower. <p>Toughness: <font color="#FF0000">High</font></p> Older people are still tougher, and this is also said in the zombie world. As a result, some old zombies also went to the battlefield. ',
  ...
  oFlagZombie = InheritO(oZombie, {
    ...
    Produce: 'Flag zombies signify the incoming "stream" of zombies. <p>Toughness: <font color="#FF0000">Low</font></p> There's no doubt that flag-waving zombies love brains. But secretly he was also obsessed with the flag. Maybe it's because there's a brain painted on the flag, it's hard to say. '
  ...
  oConeheadZombie = InheritO(OrnIZombies, {
    ...
    Produce: 'His barricade helmet makes him twice as tough as a regular zombie. <p>Toughness: <font color="#FF0000">Medium</font></p> Like other zombies, the Barricade Head zombie moves forward blindly. But something made him stop, pick up a traffic barrier, and hold it against his head. Yes, he loves to party. '
  ...
  oLionDanceZombie = InheritO(oConeheadZombie, {
    ...
    Produce: 'Only appears on the 101st floor of Evergreen Tower. Zombie design comes from rdrz. <p>Toughness: <font color="#FF0000">High</font></p> Lion dance is an excellent folk art. During festivals and celebrations, folk perform lion dances to add to the fun. In the south, Guangdong's lion dance performances are the most famous. The lion is made from strips of colorful cloth. Each lion has two people performing together, one dancing the head and one dancing the tail. Performers dress up as lions and perform various lion movements to the music of gongs and drums. During the performance, the lion dancers use various moves to express southern martial arts, which is very masculine. '
  ...
  oBucketheadZombie = InheritO(oConeheadZombie, {
    ...
    Produce: 'His iron bucket helmet can withstand damage to a great extent. <p>Toughness: <font color="#FF0000">High</font><br>Weakness: <font color="#FF0000">Potato Thunder</font></p> Iron bucket-head zombies often wear Buckets are unique in an indifferent world. But in fact, he just forgot that the iron bucket was still on his head. '
  ...
  oFootballZombie = InheritO(oConeheadZombie, {
    ...
    Produce: 'The Football Zombie Show. <p>Toughness: <font color="#FF0000">Extremely high</font><br>Speed: <font color="#FF0000">Fast</font></p> On the field, football zombie performance He is 110% passionate, and he is good at attacking and defending. Even though he had no idea what rugby was. '
  ...
  oHeiFootballZombie = InheritO(oFootballZombie, {
    ...
    Produce: 'The Dark Football Zombie Show. <p>Toughness: <font color="#FF0000">Extremely high</font><br>Speed: <font color="#FF0000">Fast</font></p> His dress is low-key and deep; The leader of the zombie football world has stronger defensive capabilities, although he has no idea what football is. '
  ...
  oPoleVaultingZombie = InheritO(OrnNoneZombies, {
    ...
    Produce: 'Pole zombies use poles to jump high over obstacles. <p>Toughness: <font color="#FF0000">Medium</font><Br>Speed: <font color="#FF0000">fast, then slow (after the jump)</font><BR>Features: <font color="#FF0000">Leap over the first plant he encountered</font></p>Some zombies are eager to go further and get more, which also drives them from ordinary to extraordinary. That's the pole zombie. ',
  ...
  oNewspaperZombie = InheritO(OrnIIZombies, {
    ...
    CName: "Newspaper Reading Zombie",
    ...
    Produce: 'His newspapers offered only limited defence. <p>Toughness: <font color="#FF0000">Low</font><br>Newspaper Toughness: <font color="#FF0000">Low</font><br>Speed: Normal, then fast (lost After the newspaper)</p>The newspaper reading zombie who is obsessed with completing his Sudoku puzzle. No wonder he is so abnormal. ',
  ...
  oScreenDoorZombie = InheritO(oNewspaperZombie, {
    ...
    Produce: 'His iron bars serve as effective shields. <p>Toughness: <font color="#FF0000">Low</font><br>Iron Gate Toughness: <font color="#FF0000">High</font><br>Weakness: Big Spray Mushroom and Magnetic Mushroom</p>The last time the Door Panel Zombie visited the homeowner, the defense was not professional. After eating the homeowner’s brain, he took away his iron gate. ',
  ...
  oTrashZombie = InheritO(oScreenDoorZombie, {
    ...
    Produce: "The mysterious zombie that haunts the Tower of Evergreen.</p> There is a story: an old man bought a house, and soon there was a young man kicking trash cans nearby. The old man couldn't stand the noise, so he and the young man People say, "If you kick the trash can every day, I will give you a dollar." The young man was very happy and kicked up the trash can. Three days later, the old man said: "Because of inflation, I can only give you 50 cents from tomorrow." "The young man was not very happy, but he still accepted it. In the afternoon, he continued to kick the trash can. Five days later, the old man said to him: "I haven't received a pension recently, and I can only give two cents. "Two cents?" "The young man got angry and never kicked the trash can again."
  ...
  oDuckyTubeZombie1 = InheritO(oAquaticZombie, {
    ...
    Produce: 'A duck lifebuoy makes zombies float on the water. <p>Toughness: <font color="#FF0000">Low</font><br>Only appears in the pool level</font></p>Only certain zombies can become lifebuoy zombies. Not every zombie is up to the task. Some of the life preservers were a little leaky, but they failed to notice, so they left and gave up on their thirst for brains. ',
  ...
  oWarshipsZombie = InheritO(oDuckyTubeZombie1, {
    ...
    Produce: 'Usually found in ponds during the last wave. <p>Toughness: <font color="#FF0000">Extremely high</font><br>Only appears in the pool level</font></p> You must be curious about the three zombies on the warship hiding in the water What it felt like, they watched helplessly as one of their companions fell into the sea and gave birth, but none of this mattered: "Brain!". ',
  ...
  oDuckyTubeZombie2 = InheritO(oDuckyTubeZombie1, {
    ...
    CName: "Roadblock Zombie Riding a Duck",
  ...
  oDuckyTubeZombie3 = InheritO(oDuckyTubeZombie2, {
    ...
    CName: "Iron barrel zombie riding a duck",
  ...
  oDuckyTubeZombie4 = InheritO(oDuckyTubeZombie3, {
    ...
    CName: "Iron Gate Zombie Riding a Duck",
  ...
  oSnorkelZombie = InheritO(oDuckyTubeZombie1, {
    ...
    Produce: 'Diving zombies can move underwater. <p>Toughness: <font color="#FF0000">Low</font><br>Features: <font color="#FF0000">Sneak to avoid being attacked<br>Only appears in the pool level</font ></p>Zombies don't breathe. They don't need air. So why do diving zombies need a diving gear to dive? <br>Answer: Peer pressure. ',
  ...
  oSubZombie = InheritO(oSnorkelZombie, {
    ...
    Produce: 'A powerful mechanical submarine that can dodge most attacks in the water. <p>Toughness: <font color="#FF0000">Extremely high</font><br>Features: <font color="#FF0000">Dive underwater to avoid being attacked<br>Only appears in the pool level< /font></p>This is an invincible submarine built by the author Zombie himself. Don’t try to crush it. His fierce attack will only make your plants die faster! . ',
  ...
  oSmallDuckyTubeZombie1 = InheritO(oDuckyTubeZombie1, {
    ...
    CName: "Little Duck Lifebuoy Zombie",
  ...
  oZomboni = function() {
    ...
    return InheritO(OrnNoneZombies, {
      ...
      Produce: 'The Ice Truck Zombie uses ice and snow to run over your plants. <p>Toughness: <font color="#FF0000">High</font><br>Features: <font color="#FF0000">crushes plants, leaving an ice path</font></p> Often mistaken for a zombie driving an ice truck, the ice truck zombie is actually an entirely different biological form, more closely related to space orks than zombies. ',
  ...
  oDolphinRiderZombie = InheritO(oAquaticZombie, {
    ...
    Produce: 'Dolphin Rider Zombies are adept at exploiting weaknesses in your pool's defenses. <p>Toughness: <font color="#FF0000">Medium</font><br>Speed: <font color="#FF0000">Fast, Slow (after jump)</font><br>Features: <font color="#FF0000">Leap over the first plant he encountered</font><br>Only appears in the pool level</font></p> The dolphin is actually a zombie. ',
  ...
  oImp = InheritO(OrnNoneZombies, {
    ...
    Produce: 'Imp zombies will break through your defenses quickly. </p><p>Toughness: <font color="#FF0000">Low</font><br>In fact, imp zombies are born to run very fast. Some lazy imp zombies like to stick to giant zombies, but some diligent ones like to stick to giant zombies. , they often go out and run marathons in groups. '
  ...
  oJX = InheritO(OrnNoneZombies, {
    ...
    Produce: 'A relative of the Imp Zombie, the attack seems to have been improved a lot. </p><p>Toughness: <font color="#FF0000">Medium</font><br> He is short and likes the crab shells he picked up, and the V-shaped crab claws make him even more excited. , even forgetting the disadvantage of height. '
  ...
  oJackinTheBoxZombie = InheritO(OrnNoneZombies, {
    ...
    Produce: 'This zombie comes with an exploding Pandora's box. </p><p>Toughness: <font color="#FF0000">Medium</font><br>Speed: <font color="#FF0000">Fast</font><br>Features: <font color ="#FF0000">The doll box will explode when opened</font><br>Weakness: <font color="#FF0000">Magnetic Mushroom</font><br>This zombie is chilling, not because of its coldness Body but because of his madness. ',
...
oBalloonZombie = InheritO(OrnIZombies, {
  ...
  Produce: 'Balloon zombies float in the air, evading most attacks. <p>Toughness: <font color="#FF0000">Low</font><br>Features: <font color="#FF0000">Flying</font><br>Weaknesses: <font color="#FF0000 ">Cactus and Clover</font></p> Balloon zombies are so lucky. Balloons have many benefits that no other zombie has ever picked up. ',
  ...
  Produce: 'Bad fish zombies use fish-shaped aircraft to avoid attacks on land. <p>Speed: <font color="#FF0000">Fast</font><br>Characteristics: <font color="#FF0000">Flying</font><br>Weaknesses: <font color="#FF0000 ">Cactus</font></p>Having once stood on the shoulders of giants, he also wanted to experience the feeling of being a giant. He tied the fish-shaped aircraft to his back, but he never expected that this thing would actually make him Fly by yourself! ',
  ...
  Produce: 'Zombies in costume. <p>Toughness: <font color="#FF0000">Low</font></p>Does this commoner temperament remind you of ordinary zombies? Yes, he's the distant Chinese cousin of the common zombie. This family are loyal brain seekers. '
...
oCConeheadZombie = InheritO(OrnIZombies, {
  ...
  Produce: 'His bamboo basket helmet makes him more able to withstand attacks from plants<p>Toughness: <font color="#FF0000">Carries ordinary armor</font></p> The bamboo basket zombie is a good father who runs the house , his biggest hobby is chasing others to ask where they can buy brains on sale. '
...
oCBucketheadZombie = InheritO(oCConeheadZombie, {
  ...
  Produce: 'His porcelain bowl can effectively withstand the impact of projectiles<p>Toughness: <font color="#FF0000">Carry strong armor</font></p>Zombies cannot bear to send beggar zombies to the battlefield. They are afraid of hearing "One is broken, two are broken...". '
...
othugZombie = InheritO(OrnNoneZombies, {
  ...
  Produce: 'Assassin zombies break through your formation unexpectedly<p>Toughness: <font color="#FF0000">High</font></p> Assassins endured brutal training while alive; after death, although they have forgotten Although he had completed the assassination mission, he still knew the Qinggong and thaumaturgy skills he had trained repeatedly, and of course he still had that delicious brain that he couldn't forget. ',
  ...
  Produce: 'Same as a corpse, but this guy is different<p>Toughness: <font color="#FF0000">High</font><br>Features: <font color="#FF0000">The talisman was beaten After dropping it, it will enter an explosive state. </font></p>The Talisman Zombie was in the first rank when he was alive, so even though he can no longer walk well, he still reminds himself: put on the robe and the top... ',
...
oZZ = InheritO(OrnNoneZombies, {
  ...
  Produce: 'The wraith zombie appears everywhere, and many times, she is even invisible. <p>Toughness: <font color="#FF0000">Medium</font><br>Features: <font color="#FF0000">Possible to neutralize bullet attacks</font></p> Some ghosts manage to be After salvation, one cannot go to heaven and can only play mischief in the human world. Since the zombies appeared, the ghosts have become excited, as if they have found their own family. But she was still as afraid of light as before. '

}), oEmperor = InheritO(oCZombie, {

  EName: "oEmperor",

  CName: "Qin Shihuang Zombie",
  ...
  Produce: 'Qin Shihuang's zombie is so domineering and majestic, is that right? <p>Toughness: <font color="#FF0000">Very high</font><br>Speed: <font color="#FF0000">Slow</font></p> Qin Shi Huang even dreamed of becoming immortal! Ever since I turned into a zombie, I have been eating brains three times a day, and I have become immortal! Every day in the endless Great Wall, pursuing my brain...'
  ...
  Produce: 'A new generation of Dr. Zombie King appears. <p>Strength: <font color="#FF0000">Immortality</font></p> Hey! How did you end up in the game? I hear players ask this all the time. Well, this is all to blame on a guy named Yan Qilun. '
...
oWJY1 = InheritO(oDuckyTubeZombie1, {
  ...
  Produce: 'The streamlined shrimp head makes him twice as fast as other zombies. <p>Toughness: <font color="#FF0000">Low</font><br>Weakness: <font color="#FF0000">Ice Shooter</font></p> Floating on the bottom of the sea for a long time makes him He had the illusion that he was flying, and he firmly believed that wearing a shrimp on his head would make him fly higher and farther. '

}), oCXZombie = InheritO(oZombie, {

  EName: "oCXZombie",

  CName: "Prime Minister Turtle Zombie",
  ...
  Produce: 'His hard shell reduces most damage. <p>Toughness: <font color="#FF0000">Very high</font><br>Weakness: <font color="#FF0000">Starfish Fruit</font></p> In order to climb into yourself The turtle shell did not fit the shape, and he did not hesitate to give up his dignity as a zombie. Finally, after the hundredth try, he successfully squeezed himself into the turtle shell and could never get out again. '
  ...
  return InheritO(oZomboni, {
    ...
    CName: "Dragon King of the East China Sea",
    ...
    Produce: 'The Dragon King of the East China Sea has an infinitely extended body and leads the zombie army to break through your formation. <p>Toughness: <font color="#FF0000">Immortality</font><br>Skills: <font color="#FF0000">Infinite body, crushing plants</font></p>Zombie A new generation of underwater combat machine developed by Dr. Wang. The doctor spent nearly a year carefully polishing and strengthening everything from the Dragon King's drainage system to every water chestnut. At this moment, the zombie genius is immersed in the joy of completing the machine. ',
